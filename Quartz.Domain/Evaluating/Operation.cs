...
public class Operation(string name, IEnumerable<string> parameters, string result, Func<Instance[], Scope, Range<Position>, Instance> content, Scope location) : Symbol(name)
{
